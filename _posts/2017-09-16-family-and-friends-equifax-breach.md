...
What follows is a no-nonsense list of steps to take
...
<!--
There is a lot of speculation out there on how our breached information can and will be used
    in all sorts of creative ways
    (e.g., fraudulent medical claims,
        other fraudulent insurance claims,
        obtaining your tax returns).
Some issues can be addressed with credit freezing and fraud alerts;
    note that this is not a silver bullet and other issues may arise in the coming months/years.
-->
...
### Set up banking alerts (recommended step #4; optional)
...
### Parents
These issues don't necessarily apply to minors but you should consider whether or not it might make sense in your case to carry out the above prescribed actions on their behalf as well.
-->
...
<!--
Many students at Dartmouth, for example, received an email with a "secure PDF" attachment;
    the email sender claimed to be the President at Dartmouth! (But, of course, it was not!)
-->
...
With respect to fraud alert products, the main benefit of products like "TrustedID Premier"
